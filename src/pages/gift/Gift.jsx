...
function Gift() {
  ...
  useEffect(() => {
      ...
      setData(basketData.maindb.gift)
        ...
        <div className={`${containerClass}`}>
          <div className="giftWrapper">
              ...
              <div className="cards">
                ...
                >
                  {data?.featured?.map((item,key) =>
                    <SwiperSlide key={key+item.img}><Link><img src={`${item.img}`} alt="" /></Link></SwiperSlide>
                  )}
            ...
            <div className="instantNews">
              ...
              <p className="text-xs pl3">New! Effortlessly send up to 10 eGifts per purchase. Select a design to start!</p>
            </div>
            <div className="question">
              <div className="questionWrap">
                <div className="top">
                  <div className='topstart'>
                    <h2 className="sb-heading text-md pr3 text-semibold" tabIndex="-1">Received a gift card?</h2>
                    <p>Earns 2 X  per $1</p>
                  </div>
